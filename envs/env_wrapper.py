...
def maatari_test():
    env = GroupMaAtariEnv(group_type="unit_type", game_name='basketball_pong',
                          obs_type='grayscale_image', max_cycles=1000)
    ...
    while True:
        ...
        next_obs_dict, reward_dict, done_dict, truncate_dict, info_dict, camp_shared_info_dict = env.step(action_dict)
        print(step)
        if done_dict:
            print('done')
